...
4. 網站把講稿、講師資料與每頁視覺方向整理成 11 頁 GPT Images 生圖任務。使用者在自己的 ChatGPT 工作階段逐頁生圖，再自動或手動把圖片放回網站。
...
網站同時註冊 WebMCP 工具，可讓支援 WebMCP 的 ChatGPT 或 Codex 讀取目前頁面的 11 頁生圖任務、放回單頁背景圖及檢查 PDF 匯出狀態。依 [OpenAI Site tools 文件](https://learn.chatgpt.com/docs/webmcp)，使用者須在 ChatGPT 桌面版的內建瀏覽器開啟網站，且功能是否可用仍取決於版本、模型、工作區與推出狀態。
